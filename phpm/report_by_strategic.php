    ...
    <td><table width="926" border="0" cellspacing="0">
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF">
        	<div id="content">
            	<fieldset>
                	<legend>รายงานโครงการตามยุทธศาสตร์</legend>
                    	<div id="naiv2">ปีงบประมาณ <?php include("../inc/report_strategic_year.php"); ?></div>
                        <?php
						switch($mode){
							case "1" : include("report_strategic3.php"); break; 
							default: include("report_by_strategic2.php"); break;
						} 
						?>
                </fieldset>
            </div>
