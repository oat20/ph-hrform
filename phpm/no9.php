    ...
    <td><table width="900" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <p>&nbsp;</p>
          ...
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <div id="nagiv"><a href="index.php">หน้าหลัก</a> > เสนอโครงการประจำปี</div>
          <div id="content">
          
          	<?php 
		   		switch($f)
				{
					case "f9" : include("../admin/compcode/form_9.html"); break;
					case "f10" : include("../admin/compcode/form_10.html"); break;
					case "f11" : include("../admin/compcode/form_11.html"); break;
					case "f12" : include("../admin/compcode/form_12_16.php"); break;
					case "f14" : include("../admin/compcode/form_14.php"); break;
				}
			?>
          </div>
