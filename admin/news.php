...
<div id="contrainer">
  ...
  <div id="body">
    ...
    <div class="submenu2">
    	<ul>
        	<li><a href="news.php">รายการข่าว</a></li>
            <li><a href="news.php?mode=add">เพิ่มข่าวสาร</a></li>
        </ul>
    </div>
  	<?php 
		switch($mode){
			case "add" : include"compcode/form_insertnews.php"; break;
			case "edit" : include"compcode/edit_datanews.php"; break;
			default : require "compcode/_show_strategic.php"; break; 
		}
	?>
    <br class="spacer">
  </div>
