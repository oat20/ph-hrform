...
<table class="table1" width="100%">
	<tbody>
	<tr>
    	<td colspan="2"><center><img src="<?php print $livesite."img/personel/thumbnail/".$ob_personel['per_img'];?>" class="img_thumbnail120x140" /></center></td>
    </tr>
        <tr>
        ...
        <tr>
          ...
          <td valign="top" class="td1" background="compcode/picture/bar07.jpg"><?php print $ob_personel['per_lnamet'];?></td>
  </tr>
        <tr>
        ...
        <tr>
              ...
              <td background="compcode/picture/bar07.jpg" class="td1"><?php print $per_group[$ob_personel['per_group']];?></td>
    </tr>
        <tr>
          <th background="compcode/picture/bar07.jpg" class="td1">เพศ</th>
          <td background="compcode/picture/bar07.jpg" class="td1"><?php print $per_sex[$ob_personel['per_sex']];?></td>
        </tr>
        <tr>
          <th background="compcode/picture/bar07.jpg" class="td1">กำหนดเป็นหัวหน้าภาควิชา / ส่วนงาน</th>
          <td background="compcode/picture/bar07.jpg" class="td1"><?php print $cf_perisboss[$ob_personel['per_isboss']];?></td>
        </tr>
        <tr>
