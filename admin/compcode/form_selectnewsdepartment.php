...
<br>
<form name="checkoutLimited" method="post" action="compcode/load_department.php">

<table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
<tr><td colspan="4" background="compcode/picture/bar_null.jpg"><div align="center" class="boldWhite_13">เลือกข่าว hotnew 4 ข่าว </div></td>
</tr>
<tr><td>
...
$sql = "select * from detail_news  where cate_detail='2'  and   show_news  like  '%y%'  and  status_hotnews not like  '%1%' ORDER BY id_detail  DESC limit 0,$items ";
...
<tr align="right"   bgcolor=#E0E3CE>
 ...
 <td colspan="5"><img src="compcode/picture/bar08.jpg" width="780"  height="6"></td>
    ...
    checkboxlimit(document.forms.article_test.number, 4)
</script> 
