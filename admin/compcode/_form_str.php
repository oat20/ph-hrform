...
<div class="container">
	...
	<div class="panel panel-default">
    	<div class="panel-heading">
        	<h3 class="panel-title"><a href="_show_substr.php"><i class="fa fa-arrow-left"></i> เพิ่มยุทธศาสตร์มหาวิทยาลัยฯ</a></h3>
        </div>
        		...
        		<div class="row">
                	<div class="col-sm-6">
                    	<div class="form-group">
                            ...
                            <input name="nameth" type="text" id="name_type" size="50" maxlength="100" class="form-control">
                        </div>
                    </div>
