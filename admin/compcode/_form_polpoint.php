...
/*	if(check_admin($authuser))
  ...
  */
  ...
  <table border=0 cellpadding=3  cellspacing=0>
      ...
      <tr  >
       <td class="formcoltitle" background="compcode/picture/bar07.jpg" align="right" valign="top">ประเด็นนโยบาย:</td>
       <td background="compcode/picture/bar07.jpg" class="formcol2"><textarea name="" cols="80" rows="6" wrap="virtual"></textarea></td>
      </tr>
       <tr  >
       <td class="formcoltitle" background="compcode/picture/bar07.jpg" align="right">อยู่ภายใต้นโยบายรัฐบาล:</td>
       <td background="compcode/picture/bar07.jpg" class="formcol2">
       <select>
       	<option value="0">- เลือกรายการ -</option>
        <?php
		$sql="select * from policy order by pol_id desc";
		$exec=mysql_query($sql);
		while($ob=mysql_fetch_array($exec)){
			print "<option value=".$ob["pol_id"].">- ".$ob["policy"]."</option>";
		}
		?>
       </select>
       </td>
