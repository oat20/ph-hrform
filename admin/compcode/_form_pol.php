...
/*	if(check_admin($authuser))
  ...
  */
  ...
  <table border=0 cellpadding=3  cellspacing=0>
      ...
      <tr  >
       <td class="formcoltitle" background="compcode/picture/bar07.jpg" align="right">นโยบายรัฐบาล:</td>
       <td background="compcode/picture/bar07.jpg" class="formcol2"><input name="name_type" type="text "id="name_type" size="80" maxlength="200"></td>
      </tr>
         <tr>
