...
<div id="contrainer">
  ...
  <div id="body">
    ...
    <div class="submenu2">
    	<ul>
        	<li><a href="event.php">รายการกิจกรรม</a></li>
            <li><a href="event.php?mode=add">เพิ่มกิจกรรม</a></li>
        </ul>
    </div>
  	<?php 
		switch($mode){
			case "add" : include "event/formaddevent.php"; break;
			case "edit" : include "event/form,editevent_data.php"; break;
			default : require "event/eventtoday.php"; break;  
		}
	?>
    <br class="spacer">
  </div>
