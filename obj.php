...
<div id="warp">
	...
	<div id="right">
   	  <h1>เป้าประสงค์หลัก</h1>
      <div class="submenu"><ul><li><a href="obj.php?mode=view">แสดงรายการ</a></li><li><a href="obj.php?mode=add">เพิ่มรายการ</a></li></ul></div>
      <div class="post">
    	<?php 
			switch($mode){
				case "add" : include("admin/compcode/_form_budget.php"); break;
				default : include("admin/compcode/_show_budget.php"); break;
		 	}
		 ?>
    </div>
  </div>
