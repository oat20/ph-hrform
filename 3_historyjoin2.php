...
<div class="container-fluid">
	...
	<ol class="breadcrumb">
      <li><a href="profile/profile.php"><i class="fa fa-arrow-left fa-fw"></i> ประวัติการเข้าร่วมปฎิบัติงานบริการวิชาการ</a></li>
    </ol>
 ...
 if(empty($_GET['dev_approve'])){
	$sql="select * from $db_eform.develop as t1
		...
		inner join $db_eform.develop_course_personel as t7 on(t1.dev_id = t7.dev_id)
				where t7.per_id = '$_SESSION[ses_per_id]'
...
?>
  <tr   bgcolor="<?php echo "$color"; ?>" class="text">
    ...
    <td class="text" align="center"><?php echo $rs['dev_id'].'<br><i class="glyphicon glyphicon-user"></i> '.$rs['per_fnamet'].' '.$rs['per_lnamet'].'<br><i class="fa fa-clock-o"></i> '.dateFormat_02($rs['dev_create']);?></td>
    ...
    <td><?php echo number_format(mysql_num_rows($sql03));?></td>
    ...
    <td class="text">
    	<a href="academicservice/print-form01-pdf.php?getTrackid=<?php print $rs['dev_trackid'];?>" class="btn btn-default btn-xs" target="_blank">รายละเอียดโครงการ</a>
    </td>
  </tr>
