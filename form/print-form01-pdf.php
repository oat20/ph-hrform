...
$content.='<p>เรื่อง <strong>ขออนุมัติเดินทางไปปฏิบัติงาน การพัฒนาบุคลากร การฝึกอบรม/ประชุม</strong></p>';
...
$content.='<p><strong>หลักสูตร/หัวข้อโครงการ</strong> '.$ob['dev_onus'].' <strong>ระหว่างวันที่</strong> '.dateformat_03($ob['dev_stdate']).' ถึง '.dateformat_03($ob['dev_enddate']).' <strong>ตั้งแต่เวลา</strong> '.$ob['dev_timebegin'].' ถึง '.$ob['dev_timeend'].' <strong>ณ</strong> '.$ob['dev_place'].'</p>';
