...
<div class="container-fluid">
	...
	?>
    <form action="../admin/2_editform2_action.php" method="post" id="formDefault" enctype="multipart/form-data">
        ...
        <tr >
              ...
              <td background="../admin/compcode/compcode/picture/back_1.jpg" class="tdpadding">
                <div class="form-group">
                    ...
                    <div class="form-group">
                    	<div id="devTypeother">
                        	<?php if($rDevelop['dev_type']=='22'){$disabled='';}else{$disabled='disabled';}?>
