...
<div class="container-fluid">
	<ol class="breadcrumb">
      <li><a href="<?php print $livesite;?>report/index.php"><i class="fa fa-arrow-left"></i> รายงานจำแนกตามตำแหน่งวิชาการ</a></li>
    </ol>
	...
	<div class="row">
        ...
        <div class="col-lg-10">
            ...
            <div class="row">
            	<?php
				$sql01=mysql_query("select * from phper2.develop_main_type where dm_use='yes' order by dm_id");
                        ...
                        <div class="panel-body">
                        	<div class="table-responsive">
                            	<table class="table table-striped table-bordered regBlack_14">
                                    ...
                                    <tbody>
                                    	<?php
										$sql02=mysql_query("select * from phper2.job_academic where ja_use='yes' order by ja_id asc");
										while($ob02=mysql_fetch_assoc($sql02)){
											...
											$sql03=mysql_query("SELECT count(develop.dev_id) as countDevid
															...
															AND personel.ja_id =  '$ob02[ja_id]'");
											$ob03=mysql_fetch_assoc($sql03);
											
											echo '<tr>
												<td>'.$ob02['ja_name'].'</td>
												<td class="text-center"><strong>'.number_format($ob03['countDevid']).'</strong></td>
												<td class="text-center"><a href="groupByjobacademic-xls.php?dev_stdate='.$keyDevstdate.'&dev_enddate='.$keyDevenddate.'&dm_id='.$ob01['dm_id'].'&ja_id='.$ob02['ja_id'].'" target="_blank"><i class="fa fa-download"></i></a></td>
											</tr>';
										}
										?>
                                    </tbody>
