...
require_once "../lib/writeexcel/class.writeexcel_workbook.inc.php";
            ...
            $worksheet->write(A1,iconv("utf-8","tis-620","รายงานจำแนกตามภายในประเทศ และต่างประเทศ"), $xlscelldesc_header);
			...
			$sql_1= "select * from phper2.develop
						...
						inner join phper2.develop_location_type on (develop.lt_id = develop_location_type.lt_id)
						...
						and develop.dev_local = '$_GET[dev_local]'
