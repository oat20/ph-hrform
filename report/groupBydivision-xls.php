...
require_once "../lib/writeexcel/class.writeexcel_workbook.inc.php";
            ...
            $worksheet->write(A1,iconv("utf-8","tis-620","รายงานจำแนกตามส่วนงาน"), $xlscelldesc_header);
			...
			$sql_1= "select * from $db_eform.develop
						...
						and personel_muerp.per_dept='$_GET[dp_id]'
            ...
            # ตรงนี้คือดึงข้อมูลจาก mysql มาใส่ใน Cell
				...
				//วัตถุประสงค์
						...
						$worksheet->write("O$xlsRow", iconv('utf-8','tis-620',$ob['$dvt_name']),  $xlsCellDesc);
