...
<div class="container-fluid">
	<ol class="breadcrumb">
      <li><a href="<?php print $livesite;?>report/index.php"><i class="fa fa-arrow-left fa-fw"></i> รายงานปฏิบัติงานพัฒนาบุคลากรจำแนกตามส่วนงาน</a></li>
    </ol>
            	...
            	<div class="col-lg-12">
                	<div class="panel panel-info">
                        ...
                        <div class="panel-body">
							...
							echo 'ข้อมูลช่วงวันที่ '.dateThai($keyDevstdate).' - '.dateThai($keyDevenddate);
							?>
                        </div>
                                    ...
                                    <tbody>
										...
										while($ob02=mysql_fetch_assoc($sql02)){
											...
											echo '<tr>
												...
												<td class="text-center"><a href="groupBydivision-xls.php?dev_stdate='.$keyDevstdate.'&dev_enddate='.$keyDevenddate.'&dm_id='.$ob01['dm_id'].'&dp_id='.$ob02['dp_id'].'" target="_blank" class="btn btn-default btn-sm"><i class="fa fa-info"></i> รายละเอียด</a></td>
											</tr>';
