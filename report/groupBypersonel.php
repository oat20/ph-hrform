        	...
        	<div class="panel panel-info">
            	<div class="panel-heading">
                	<h3 class="panel-title">
                    	<a href="<?php print $livesite;?>report/index.php"><i class="fa fa-arrow-left fa-fw"></i> รายงานปฏิบัติงานพัฒนาบุคลากรจำแนกรายบุคคล</a>
                    </h3>
                </div>
                    	...
                    	<table class="table table-bordered table-striped">
                            ...
                            <tfoot>
                            	<tr class="regBlack_14">
                                    ...
                                    <th></th>
                                    <th>รวม</th>
                                    <th class="text-center"><a href="groupBypersonel03-xls.php?dev_stdate=<?php print $dev_stdate;?>&dev_enddate=<?php print $dev_enddate;?>&dm_id=1" target="_blank"><?php echo number_format($sumCountdevid);?></a></th>
                                    <th></th>
                                </tr>
                            </tfoot>
                        </table>
