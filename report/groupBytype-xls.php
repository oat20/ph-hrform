...
require_once "../lib/writeexcel/class.writeexcel_workbook.inc.php";
            ...
            $worksheet->write(A1,iconv("utf-8","tis-620","รายงานจำแนกตามประเภทบุคลากร"), $xlscelldesc_header);
			...
			$sql_1= "select * from $db_eform.develop
						...
						and personel_muerp.per_type='$_GET[pert_id]'
            ...
            # ตรงนี้คือดึงข้อมูลจาก mysql มาใส่ใน Cell
				...
				//วัตถุประสงค์
						...
						$worksheet->write("J$xlsRow", iconv("utf-8","tis-620",$ob['dev_place'].' ('.$cf_local[$ob['dev_local']]['name'].')'),  $xlsCellDesc);
