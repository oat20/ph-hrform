...
<div class="container-fluid">
	<ol class="breadcrumb">
      <li><a href="<?php print $livesite;?>report/index.php"><i class="fa fa-arrow-left"></i> รายงานจำแนกตามภายในประเทศ และต่างประเทศ</a></li>
    </ol>
                                    ...
                                    <tbody>
										...
										foreach($cf_local as $key=>$value){
											...
											$sql03=mysql_query("SELECT count(develop.dev_id) as countDevid
															...
															and develop.dev_local='$key'");
											$ob03=mysql_fetch_assoc($sql03);
											
											echo '<tr>
												<td>'.$value['name'].'</td>
												<td class="text-center"><strong>'.number_format($ob03['countDevid']).'</strong></td>
												<td class="text-center"><a href="groupBylocal-xls.php?dev_local='.$key.'&dev_stdate='.$keyDevstdate.'&dev_enddate='.$keyDevenddate.'&dm_id='.$ob01['dm_id'].'" target="_blank"><i class="fa fa-download"></i></a></td>
											</tr>';
										}
										?>
                                    </tbody>
