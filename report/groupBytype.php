...
<div class="container-fluid">
	<ol class="breadcrumb">
      <li><a href="<?php print $livesite;?>report/index.php"><i class="fa fa-arrow-left fa-fw"></i> รายงานจำแนกตามประเภทบุคลากร</a></li>
    </ol>
	...
	<div class="row">
        ...
        <div class="col-lg-10">
            ...
            <div class="row">
            	<?php
				$sql01=mysqli_query($condb, "select * from $db_eform.develop_main_type 
					where dm_use='yes' 
					and dm_id = '1'
					order by dm_id");
                        	...
                        	<div class="table-responsive">
                            	<table class="table table-striped table-bordered regBlack_14">
                                    ...
                                    <tbody>
                                    	<?php
										$sumcountdevid = 0;
											$sql03=mysqli_query($condb, "SELECT t4.pert_id,
												t4.pert_name,
												count(develop.dev_id) as countDevid
															...
															inner join $db_eform.personel_type as t4 on(personel_muerp.per_type = t4.pert_id) 
											...
											echo '<tr>
												<td>'.$ob03['pert_name'].'</td>
												<td class="text-center"><strong>'.number_format($ob03['countDevid']).'</strong></td>
												<td class="text-center"><a href="groupBytype-xls.php?dev_stdate='.$keyDevstdate.'&dev_enddate='.$keyDevenddate.'&dm_id='.$ob01['dm_id'].'&pert_id='.$ob03['pert_id'].'" target="_blank" class="btn btn-default btn-sm"><i class="fa fa-download"></i> รายละเอียด</a></td>
											</tr>';
