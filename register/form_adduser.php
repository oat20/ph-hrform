...
<div class="container">
	...
	<div class="panel panel-default">
    	<div class="panel-heading">
        	<h3 class="panel-title"><a href="../admin/compcode/_show_alluser.php"><i class="fa fa-arrow-left"></i> Add User</a></h3>
        </div>
    	<div class="panel-body">
			...
			print $insert_msg;
			?>
            <form name="adduser" action="<?php print $_SERVER['../admin/compcode/PHP_SELF'];?>" method="post" ENCTYPE="multipart/form-data" id="defaultForm">
                <div class="row">
                    <div class="col-sm-6">
