...
<div class="container">
	<div class="row">
    	<div class="col-sm-12">
            ...
            <form method="post" id="formDefault" action="admin-form-action.php">
            	<div class="row">
                	<div class="col-sm-6 col-sm-offset-6">
                    	<div class="form-group form-group-sm">
                        	<label class="control-label">ลงวันที่:</label>
                            <input name="dev_orddate" type="text" class="form-control" id="dev_orddate" required>
                        </div>
                    </div><!--col-->
                </div><!--row-->
            	<!--ข้อมูลผู้ขออนุมัติ-->
                	...
                	<div class="col-sm-6">
                    	<div class="form-group form-group-sm">
                            ...
                            <select name="per_name" class="form-control select select-inverse select-sm" data-toggle="select" required>
                            	<option value="">&nbsp;</option>
                                <?php
								$qPersonel=mysql_query("select * from $db_eform.personel_muerp as t1
								...
								while($rPersonel=mysql_fetch_assoc($qPersonel)){
									echo '<option value="'.$rPersonel['per_id'].'/'.$rPersonel['per_fnamet'].' '.$rPersonel['per_lnamet'].'">'.$rPersonel['per_fnamet'].' '.$rPersonel['per_lnamet'].'</option>';
								}
								?>
                            </select>
                        </div>
                ...
                <div class="row">
                	<div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select name="dev_type" class="form-control select select-inverse select-sm" data-toggle="select" required>
                            	<option value="">&nbsp;</option>
                            <?php
                            ...
                            while($ob=mysql_fetch_assoc($sql)){
								...
								echo '<option value="'.$ob['la_id'].'">'.$ob['la_name'].'</option>';
                            }
                            ?>
                            </select>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="row">
                            <?php
							foreach($cf_devleave_status as $k=>$v){
								echo '<div class="col-sm-4"><label class="radio"><input name="dev_formstatus" type="radio" value="'.$k.'" data-toggle="radio" required> '.$v['name'].'</label></div>';
							}
							?>
                            </div><!--row-->
                            <input name="dev_formstatus_comment" type="text" class="form-control" placeholder="อื่นๆ ระบุ">
                        </div>
