...
$content='<table>
				<tbody>
					<tr>
						...
						<td width="45%" class="pmhMiddleRight font-16">
							<br><br>'.$ob['dp_name'].'
							<br>โทร. '.$ob['t9_tel'].'
						</td>
				</tbody>
...
<br>เลขประจำตำแหน่ง '.$ob['per_number'].' สังกัด '.$ob['dp_name'].'
...
$content.='<p class="font-16">ชื่อทุน '.$ob['dev_fundname'].'
 (เฉพาะกรณีขออนุมัติลาศึกษา)  ระดับการศึกษา '.$ob['dg_name'].'  
</p>';
...
$content.='<p class="font-16">ความเห็นต้นสังกัด<br>';
		$content.='&nbsp;&nbsp;<img src="../img/check.svg" width="16"> '.$cf_devleave_status[$ob['dev_formstatus']]['name'].'&nbsp;&nbsp;'.$ob['dev_formstatus_comment'].'</p>';
					...
					<tbody>
						<tr>
							...
							if($ob['dev_bossname']=='' and $ob['dev_bosspos']==''){
								$content.='<td class="bpmClearC font-16" width="50%">
									ลงชื่อ .........................................................
									<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(.........................................................)
									<br>ตำแหน่ง .........................................................
								</td>';
...
$mpdf=new mPDF('th','A4','','thsarabun',30,20,20,10,0,0); //A4 แนวตั้ง, A4-L แนวนอน
