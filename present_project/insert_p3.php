...
if($reason != ""){
		$sql="update project set reason='$reason', pro_obj='$pro_obj', pro_target_group='$pro_target_group', pro_area='$pro_area', pro_start='$pro_start', pro_end='$pro_end' 
		where pro_id='$_SESSION[Max]'";
		mysql_query($sql);
		header("location: ../phpm/no9.php?f=f9");
}else{
