	...
	<div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<li><a href="<?php echo $livesite;?>academicservice/form_1.php">กรอกบันทึกขออนุมัติ</a></li>
				<li><a href="<?php echo $livesite;?>academicservice/_showmyacademicservice.php">ประวัติการขออนุมัติ</a></li>
			</ul>
