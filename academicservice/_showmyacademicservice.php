...
<div class="container-fluid">
	...
	<ol class="breadcrumb">
      <li><a href="../profile/profile.php"><i class="fa fa-arrow-left"></i> ประวัติการขออนุมัติปฎิบัติงานบริการวิชาการ</a></li>
    </ol>
    	...
    	<div class="btn-group">
          ...
          <ul class="dropdown-menu dropdown-menu-right">
			...
			if($rs['dev_approve']=='wait'){
				print '<li><a href="editform_1.php?getTrackid='.$rs['dev_trackid'].'" title="แก้ไข" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-pencil"></i> แก้ไขแบบฟอร์ม</a></li>
