...
<div class="container-fluid">
	...
	$sql=mysql_query("select * from $db_eform.develop
			...
			inner join $db_eform.develop_level as t9 on(develop.le_id=t9.le_id)
	...
	<div class="panel panel-default">
    	<div class="panel-heading">
        	<h3 class="panel-title clearfix">
                ...
                <div class="pull-right">
                    <a href="editform_2.php?getTrackid=<?php echo $ob['dev_trackid'];?>" class="btn btn-link"><i class="fa fa-pencil"></i></a>
        ...
        <div class="panel-footer">
        	<a href="editform_2.php?getTrackid=<?php echo $ob['dev_trackid'];?>" class="btn btn-link btn-wide"><i class="fa fa-angle-double-left"></i> กลับไปแก้ไข</a>
