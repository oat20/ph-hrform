                    	...
                    	<div class="col-sm-6">
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <p class="form-control-static"><?php echo $ob['pert_name'];?></p>
                            </div>
                        </div>
                        </div>
                </td>
                ...
                <td>
                    <div class="form-group">
                        ...
                        while($ob=mysql_fetch_assoc($sql)){
                            print '<div class="col-sm-3"><label class="radio"><input type="radio" name="dev_type" data-toggle="radio" value="'.$ob['la_id'].'">'.$ob['la_name'].'</label></div>';
                        }
                        ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            foreach($cf_local as $key=>$value){
                                print '<div class="col-sm-3"><label class="radio"><input type="radio" name="dev_local" value="'.$key.'" data-toggle="radio"> '.$value['name'].'</label></div>';
                            }
                            ?>
                        </div><!--row-->
                    </div>
