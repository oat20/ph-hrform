...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><img src="../phpm/images/index_01.jpg" width="925" height="209" alt=""></td>
  </tr>
  <tr>
    <td><table width="926" border="0" cellspacing="0">
      <tr>
        <td background="../phpm/images/index_04.jpg">&nbsp;</td>
        <td bgcolor="#FFFFFF"><div id="navi3"><?php include("../inc/gotohome.html"); ?></div></td>
        <td background="../phpm/images/index_06.jpg">&nbsp;</td>
      </tr>
      <tr>
        <td background="../phpm/images/index_04.jpg">&nbsp;</td>
        <td bgcolor="#FFFFFF">
        <div id="content">
            	<fieldset>
                	<legend>จำนวนโครงการตามปีงบประมาณ</legend>
                        <?php
						include("unitbyyear.php");
						?>
                </fieldset>
            </div>
        </td>
      ...
      <tr>
        <td width="55" background="../phpm/images/index_04.jpg">&nbsp;</td>
        <td width="804" bgcolor="#FFFFFF">&nbsp;</td>
        <td width="61" background="../phpm/images/index_06.jpg">&nbsp;</td>
      </tr>
      <tr>
        <td colspan="3" background="../phpm/images/index_08.jpg">&nbsp;</td>
        </tr>
      <tr>
