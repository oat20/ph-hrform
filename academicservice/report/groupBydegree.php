...
<div class="container-fluid">
	<ol class="breadcrumb">
      <li><a href="<?php print $livesite;?>report/index.php"><i class="fa fa-arrow-left fa-fw"></i> รายงานจำแนกตามระดับการศึกษาของบุคลากร</a></li>
    </ol>
                        	...
                        	<div class="table-responsive">
                            	<table class="table table-striped table-bordered regBlack_14">
                                    ...
                                    <tbody>
                                    	<?php
										$sumcountdevid = 0;	
											$sql03=mysqli_query($condb,"SELECT degree.dg_id,
												degree.dg_name,
												count(personel_muerp.per_id) as countDevid
											...
											echo '<tr>
												...
												<td class="text-center"><a href="groupBydegree-xls.php?dg_id='.$ob03['dg_id'].'&dev_stdate='.$keyDevstdate.'&dev_enddate='.$keyDevenddate.'&dm_id='.$ob01['dm_id'].'" target="_blank" class="btn btn-default btn-sm"><i class="fa fa-download"></i> รายละเอียด</a></td>
											</tr>';
