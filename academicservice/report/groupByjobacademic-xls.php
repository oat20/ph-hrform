...
require_once "../../lib/writeexcel/class.writeexcel_workbook.inc.php";
            ...
            $worksheet->write(A1,iconv("utf-8","tis-620","รายงานจำแนกตามตำแหน่งวิชาการ"), $xlscelldesc_header);
			...
			$sql_1= "select * from $db_eform.develop
						...
						and personel_muerp.job_id='$_GET[job_id]'
            ...
            # ตรงนี้คือดึงข้อมูลจาก mysql มาใส่ใน Cell
				...
				//วัตถุประสงค์
				$dvt_name='';	
				$sql02=mysqli_query($condb,"select * from phper2.develop_form_objective
