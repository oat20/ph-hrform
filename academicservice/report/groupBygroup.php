...
<div class="container-fluid">
	<ol class="breadcrumb">
      <li><a href="<?php print $livesite;?>report/index.php"><i class="fa fa-arrow-left fa-fw"></i> รายงานจำแนกตามกลุ่มบุคลากร</a></li>
    </ol>
                        	...
                        	<div class="table-responsive">
                            	<table class="table table-striped table-bordered regBlack_14">
                                    ...
                                    <tbody>
                                    	<?php
										$sumcountdevid = 0;
											$sql03=mysqli_query($condb,"SELECT t4.gr_id,
												t4.gr_title,
												count(develop.dev_id) as countDevid
															...
															inner join $db_eform.personel_group as t4 on (personel_muerp.per_group = t4.gr_id) 
											...
											echo '<tr>
												...
												<td class="text-center"><a href="groupBygroup-xls.php?dev_stdate='.$keyDevstdate.'&dev_enddate='.$keyDevenddate.'&dm_id='.$ob01['dm_id'].'&gr_id='.$ob03['gr_id'].'" target="_blank" class="btn btn-default btn-sm"><i class="fa fa-download"></i> รายละเอียด</a></td>
											</tr>';
