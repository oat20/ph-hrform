...
<div class="container-fluid">
	<ol class="breadcrumb">
      <li><a href="<?php print $livesite;?>report/index.php"><i class="fa fa-arrow-left fa-fw"></i> รายงานจำแนกตามยุทธศาสตร์คณะฯ</a></li>
    </ol>
                        	...
                        	<div class="table-responsive">
                            	<table class="table table-striped table-bordered regBlack_14">
                                    ...
                                    <tbody>
                                    	<?php
										$sumcountdevid = 0;
											$sql03=mysqli_query($condb,"SELECT t2.sf_id,
												t2.sf_name,
												count(develop.dev_id) as countDevid
															FROM $db_eform.develop
															inner join $db_eform.strategic_faculty as t2 on(develop.sf_id = t2.sf_id)
											...
											echo '<tr>
												...
												<td class="text-center"><a href="groupBystrategic02-xls.php?sf_id='.$ob03['sf_id'].'&dev_stdate='.$keyDevstdate.'&dev_enddate='.$keyDevenddate.'&dm_id='.$ob01['dm_id'].'" target="_blank" class="btn btn-default btn-sm"><i class="fa fa-download"></i> รายละเอียด</a></td>
											</tr>';
