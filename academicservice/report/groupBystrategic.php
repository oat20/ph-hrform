...
<div class="container-fluid">
	<ol class="breadcrumb">
      <li><a href="<?php print $livesite;?>report/index.php"><i class="fa fa-arrow-left fa-fw"></i> รายงานจำแนกตามยุทธศาสตร์มหาวิทยาลัยฯ</a></li>
    </ol>
                        	...
                        	<div class="table-responsive">
                            	<table class="table table-striped table-bordered regBlack_14">
                                    ...
                                    <tbody>
                                    	<?php
										$sumcountdevid = 0;
											$sql03=mysqli_query($condb,"SELECT t2.id,
												t2.nameth,
												count(develop.dev_id) as countDevid
															FROM $db_eform.develop
															inner join $db_eform.sub_strategic as t2 on(develop.ss_id = t2.id)
											...
											echo '<tr>
												...
												<td class="text-center"><a href="groupBystrategic-xls.php?ss_id='.$ob03['id'].'&dev_stdate='.$keyDevstdate.'&dev_enddate='.$keyDevenddate.'&dm_id='.$ob01['dm_id'].'" target="_blank" class="btn btn-default btn-sm"><i class="fa fa-download"></i> รายละเอียด</a></td>
											</tr>';
