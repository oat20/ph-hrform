        ...
        <div class="col-sm-4">
                    ...
                    <div class="col-sm-4">
                    	<div class="panel panel-info">
							...
							<div class="list-group">
                                ...
                                <!--<a href="" class="list-group-item"><i class="fa fa-angle-double-right fa-fw"></i> แสดงรายโครงการ / หลักสูตร</a>-->
                    ...
                    <div class="col-sm-4">
                    	<div class="panel panel-success">
                            ...
                            <div class="list-group">
                            	<a href="<?php echo $livesite;?>finance/summaryWithdivision.php?dev_year='.budgetyear_02(date('Y-m-d')).'" class="list-group-item"><i class="fa fa-angle-double-right fa-fw"></i> สรุปค่าใช้จ่ายตามส่วนงาน</a>
                      		<a href="<?php echo $livesite;?>finance/summaryBudget.php?dev_year='.budgetyear_02(date('Y-m-d')).'" class="list-group-item"><i class="fa fa-angle-double-right fa-fw"></i> สรุปค่าใช้จ่ายภาพรวม</a>
                            </div>
                        </div>
                    </div><!--col-->
                    <!--การเงิน-->
