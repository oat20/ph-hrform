...
<div class="container-fluid">
	<ol class="breadcrumb">
      <li><a href="<?php print $livesite;?>report/index.php"><i class="fa fa-arrow-left fa-fw"></i> รายงานจำแนกตามวัตถุประสงค์</a></li>
    </ol>
                        	...
                        	<div class="table-responsive">
                            	<table class="table table-striped table-bordered regBlack_14">
                                    ...
                                    <tbody>
                                    	<?php
										$sumcountid=0;
											$sql03=mysqli_query($condb,"SELECT t2.dvt_id,
												t2.dvt_name,
												count(develop.dev_id) as countDevid
															FROM $db_eform.develop
															inner join $db_eform.develop_type as t2 on(develop.dev_type = t2.dvt_id)
											...
											echo '<tr>
												...
												<td class="text-center"><a href="groupByobjective-xls.php?dev_stdate='.$keyDevstdate.'&dev_enddate='.$keyDevenddate.'&dvt_id='.$ob03['dvt_id'].'&dm_id='.$ob01['dm_id'].'" target="_blank" class="btn btn-default btn-sm"><i class="fa fa-download"></i> รายละเอียด</a></td>
											</tr>';
											$sumcountid+=$ob03['countDevid'];
										}
										?>
                                    </tbody>
                                     <tfoot>
                                    	<tr>
                                        	<th>รวม</th>
                                            <th class="text-center"><?php echo number_format($sumcountid);?></th>
                                            <th></th>
                                        </tr>
                                    </tfoot>
                                </table>
