...
?>
  <tr   bgcolor=<? echo "$color"; ?>>
    ...
    <td width=""        class="text"><a href="reportfollow.php?pro_id=<?=$rs['pro_id'];?>&mode=1" title="รายละเอียดโครงการ"><? echo $rs["names"];  ?></a>
    </td>
