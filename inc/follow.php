...
?>
  <tr   bgcolor=<? echo "$color"; ?>>
    ...
    <td width=""        class="text"><a href="follow.php?pro_id=<?=$rs['pro_id'];?>&mode=1" title="รายละเอียดโครงการ"><? echo $rs["names"];  ?></a>
    </td>
    ...
    <!--<td class="text" align="center"><a href="reportfollow.php?pro_id=<?=$rs['pro_id'];?>&mode=1" title="แสดงรายละเอียด"><img src="../admin/compcode/img/icon_preview.gif" border="0"></a> <a href="follow.php?pro_id=<?=$rs['pro_id'];?>&mode=1" title="แก้ไขข้อมูล"><img src="../admin/compcode/img/editpic.gif" border="0"></a><a href="#" title="ยกเลิกโครงการ"><img src="../admin/compcode/img/botton_delete.gif" border="0"></a></td> -->
